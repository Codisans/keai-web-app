        ...
        input: ({ props }) => ({
            root: {
                className: classNames(
                    ...
                    {
                        'font-sans text-base text-black  bg-white dark:bg-gray-900 p-3 border border-grey dark:border-blue-900/40 focus:outline-offset-0 focus:shadow-[0_0_0_0.2rem_rgba(191,219,254,1)] dark:focus:shadow-[0_0_0_0.2rem_rgba(147,197,253,0.5)] hover:border-blue-500 focus:outline-none':
                            !props.multiple,
