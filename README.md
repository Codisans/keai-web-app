...
wannam list categories (vertical) and their top events (horinztonal) on homepage.
Also include "special categories"

On category pages, have top tags (vertical) displaying their events horintally

Order events based on matching relevance score
